                                        ...
                                        <Col md="6" sm="12">
                                            <FormGroup>
                                                ...
                                                <input
                                                    ...
                                                    type="number"
                                                    id="price"
                                                    {...register("price", { required: 'Price is required.', validate: validatePositiveNumber })}
                                                />
                                        ...
                                        <Col md="6" sm="12">
                                            <FormGroup>
                                                ...
                                                <input
                                                    ...
                                                    type="number"
                                                    id="quantity"
                                                    {...register("quantity", { required: 'quantity is required.', validate: validatePositiveNumber })}
                                                />
