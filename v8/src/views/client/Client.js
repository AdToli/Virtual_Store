                ...
                return (
                    <div>
                        {row.products.map((product, index) => (
                            <>
                            <div key={`${product.product?.name}-${index}`} className="d-flex align-items-center">

                                <span className="p-2">
                                    <span style={{ cursor: 'pointer', textDecoration: 'underline' }} onClick={() => handleClick(product.product?.id)}>{product.product?.name}</span>
                                </span>
